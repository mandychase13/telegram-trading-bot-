...
from database.operations import get_or_create_user, get_wallet
...
async def start_handler(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    # Create or retrieve the DB user
...
async def guide_handler(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    if update.message:
        ...
        await update.callback_query.answer()
        # Edit the first part in-place, then send any additional parts as new messages
