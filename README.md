...
- **Real trade execution**: implement `execute_sol_buy()` in `blockchain/solana_client.py` using the Jupiter API (`JUPITER_API_KEY`) and `solders` for transaction signing.
